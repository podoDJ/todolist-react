        ...
        <main>
          ...
          <div className="working-list-container">
            {todos
              ...
              .map(function (item) {
                return <TodoRender key={item.id} item={item} clickRemoveButtonHandler={clickRemoveButtonHandler} clickCheckCompleteButtonHandler={clickCheckCompleteButtonHandler} />;
              })}
          </div>
